...
> ## ⚠️ The colour palette below is NOT what this site uses
>
> This file is the raw output of the `ui-ux-pro-max` design-system generator.
> Its structural guidance (Swiss-modernist grid discipline, academic serif
> typography, publication filtering, the accessibility checklist) is what the
> site follows.
>
> Its **colour recommendation is deliberately overridden.** The lab has an
> existing brand identity — the `#750F6D` purple and the logo's emblem purple,
> gold and charcoal — and that identity is the source of truth. The palette the
> site actually ships lives in `src/styles/global.css` under `@theme`, and every
> pairing is verified by `npm run contrast`.
>
> Do not apply the navy/blue values in the table below.
...
**Project:** CUHK Geophysics
**Generated:** 2026-08-26 16:54:21
